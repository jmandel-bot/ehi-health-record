...
const childTableList = [
  ...
  'PROB_UPDATES','PL_SYSTEMS','PROBLEM_LIST_ALL','PROBLEM_LIST_HX',
  ...
  'ORDER_RXVER_NOADSN','ORD_MED_ADMININSTR',
...
assert(specTables.size >= 400,
  `spec covers at least 400 tables (got ${specTables.size})`);
